...
pkgdatadir = $(datadir)/stalonetray
pkgincludedir = $(includedir)/stalonetray
pkglibdir = $(libdir)/stalonetray
pkglibexecdir = $(libexecdir)/stalonetray
...
ACLOCAL = ${SHELL} /mingw/x/stalonetray-0.8.1/missing --run aclocal-1.11
AMTAR = ${SHELL} /mingw/x/stalonetray-0.8.1/missing --run tar
AUTOCONF = ${SHELL} /mingw/x/stalonetray-0.8.1/missing --run autoconf
AUTOHEADER = ${SHELL} /mingw/x/stalonetray-0.8.1/missing --run autoheader
AUTOMAKE = ${SHELL} /mingw/x/stalonetray-0.8.1/missing --run automake-1.11
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CPP = gcc -E
CPPFLAGS =  -DFEATURE_LIST='"XPM:no DEBUG:no KDE:no"'
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /mingw/x/stalonetray-0.8.1/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = stalonetray
PACKAGE_BUGREPORT = 
...
VERSION = 0.8.1
XMKMF = 
X_CFLAGS =  -I/mingw/x/include
X_EXTRA_LIBS = 
X_LIBS =  -L/mingw/x/lib
X_PRE_LIBS = 
abs_builddir = /mingw/x/stalonetray-0.8.1
abs_srcdir = /mingw/x/stalonetray-0.8.1
abs_top_builddir = /mingw/x/stalonetray-0.8.1
abs_top_srcdir = /mingw/x/stalonetray-0.8.1
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /mingw/x/stalonetray-0.8.1/install-sh
kde_tray_support = 
...
stalonetray.spec:
	VERSION_STR=`echo 0.8.1 | sed 's/\([^\.]*\.[^\.]*\)\..*/\1/'`; \
